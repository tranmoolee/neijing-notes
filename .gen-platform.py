...
DATA = {
 ...
 "41-经脉决死生": ("neijing-41-jingmai-juesisheng", "灵枢, 经脉, 经络",
   "'决死生，处百病'——《内经》口气最大的一句话，重点藏在最后四个字：不可不通。而古人自己承认，经脉深而不见。"),
 "42-手六经": ("neijing-42-shou-liujing", "灵枢, 经脉, 十二经络",
   "手上六条经不是六条线，是三组接力赛——阴经跑到指尖把棒交给阳经。鼠标手酸的位置，两千年前就画在图上了。"),
 "43-足六经": ("neijing-43-zu-liujing", "灵枢, 经脉, 十二经络, 膀胱经",
   "撸起裤腿，六条经就排在你小腿上：外三阳内三阴，齐得不像巧合。到这篇，十二条线焊成一个闭环——'如环无端'不是修辞。"),
 "44-井荥输经合": ("neijing-44-wushu-xue", "灵枢, 本输, 五输穴",
   "古人的穴位图其实是一张水文图：气从指尖的泉眼冒出来，一路汇流成河。穴位不是孤立的点，是一条河的五个河段。"),
 "45-骨度同身寸": ("neijing-45-gudu-tongshencun", "灵枢, 骨度, 同身寸",
   "古人没有标准卷尺，干脆把你的身体做成了尺子：寸不是单位，是身体的百分比——和维特鲁威人同一个方向的聪明。"),
 "46-营卫生会": ("neijing-46-yingwei-shenghui", "灵枢, 营卫, 睡眠",
   "一碗饭下肚分成两支部队：营在脉中送补给，卫在脉外跑巡逻。卫气的昼夜班表，顺便解释了为什么老人凌晨四点就醒。"),
 "47-官针与得气": ("neijing-47-guanzhen-deqi", "灵枢, 官针, 得气",
   "得气——那种酸酸胀胀的感觉，到底是病人的还是医生的？如鱼吞钩：鱼知道，钓的人也知道。最后四个字最反直觉：气调而止。"),
 "P7-八篇回头看": ("neijing-p7-stage7-review", "第七阶段回顾, 针灸理论",
   "八篇《灵枢》拼起来是一张课程表，拧出来是同一个字：通。我还是不会扎针，但那间看了三十年的诊室，终于亮了灯。"),
 "48-本神": ("neijing-48-benshen", "灵枢, 本神, 神志",
   "魂不守舍、失魂落魄、深谋远虑——这些天天在说的词，每个字都是两千年前的心理学术语。古人把'想'拆成了六道工序。"),
 "49-口问": ("neijing-49-kouwen", "灵枢, 口问, 生活观察",
   "打哈欠、叹气、打喷嚏、耳鸣——黄帝把这些小事挨个问了一遍。叹气那条的答案温柔得不像医书：不是丧，是身体在给自己松绑。"),
 "50-大惑论": ("neijing-50-dahuolun", "灵枢, 大惑论, 失眠",
   "古人管失眠叫'卫气进不了门'：不是不想睡，是不被允许。健忘则是'楼上停电'，不是坏硬盘。两千年前的睡眠故障表。"),
 "51-淫邪发梦": ("neijing-51-yinxie-fameng", "灵枢, 淫邪发梦, 梦",
   "饿了梦拿东西，饱了梦给东西——古人的解梦表跟解梦书反着用：不从梦推吉凶，从梦推身体现状。梦是气的天气预报。"),
 "52-天年": ("neijing-52-tiannian", "灵枢, 天年, 衰老",
   "十岁好走，二十好趋，四十好坐——古人给人生每十年写好了剧本，判断指标是你'好'什么。剧本不是判决书，是坐标。"),
 "53-通天五态人": ("neijing-53-wutai-ren", "灵枢, 通天, 五态人",
   "两千年前的人格测试，五种人四种差评——因为它不是自我认同产品，是医生的工作表。分类的用途，决定分类的口吻。"),
 "54-五味": ("neijing-54-wuwei", "灵枢, 五味, 饮食",
   "没有超级食物，没有忌口清单——古人的饮食观就八个字：食养尽之，无使过之。你的气，字面意义上是饭。"),
}
