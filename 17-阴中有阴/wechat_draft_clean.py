#!/usr/bin/env python3
"""Publish wechat draft for 17-阴中有阴 with clean body text + overlaid images."""
import json, os, re, sys
from pathlib import Path
import requests

BASE = Path("/Users/tranmoo/neijing-notes/17-阴中有阴")
...
if not APP_ID or not APP_SECRET:
    print("❌ WECHAT_APP_ID or WECHAT_APP_SECRET not found")
    sys.exit(1)
...
def main():
    ...
    title = title_match.group(1).strip() if title_match else "阴阳不是二分法"
    if len(title) > 10:
        title = "阴阳不是二分法"
